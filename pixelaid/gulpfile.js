...
let path = {
    ...
    src: {
        ...
        files: [source_folder + "/*.*", "!" + source_folder + "/_*.*"],
    },
    watch: {
        ...
        img: source_folder + "/img/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/fonts/*.{ttf,woff,woff2}",
        files: source_folder + "/*{png,ico,php,txt,xml,webmanifest}",
    },
...
let build = gulp.series(clean, gulp.parallel(js, css, html, images, fonts, files));
